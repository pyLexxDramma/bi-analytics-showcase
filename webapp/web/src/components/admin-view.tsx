...
export function AdminView() {
  ...
  return (
    <AppShell
      ...
      subtitle="FTP → web/ → web_data.db (как в [main])"
    >
      ...
      <Card className="mb-6 rounded-xl">
        ...
        <Text className="mt-1">
          Нужен токен <code className="text-xs">WEBAPP_ADMIN_TOKEN</code>. Jobs в
          фоне (анти-502).
        </Text>
        ...
        <label className="mt-3 flex items-center gap-2 text-sm">
          ...
          />
          <Text>Force FTP (перекачать даже при том же размере)</Text>
        </label>
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          <button
            type="button"
            className="rounded-tremor-default border border-tremor-border bg-white px-4 py-2 font-medium disabled:opacity-60 dark:border-dark-tremor-border dark:bg-dark-tremor-background"
