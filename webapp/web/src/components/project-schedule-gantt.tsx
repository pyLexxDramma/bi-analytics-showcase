...
import { MobileTimelineCards } from "@/components/mobile-timeline-lanes";
    ...
    return (
      <MobileTimelineCards
        rows={rows.map((row, index) => ({
          ...
          title: row.label,
          badge:
            row.pct_complete != null ? `${row.pct_complete}%` : null,
          primary: {
        ...
        primaryColor={planColor}
        secondaryColor={factColor}
        primaryLegend="План"
        secondaryLegend="Факт"
        primaryLaneLabel="П"
        secondaryLaneLabel="Ф"
        showPrimaryLane={!labelPct}
