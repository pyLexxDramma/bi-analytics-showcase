...
| 4 | approved-budget | Утверждённый бюджет | `walk_20260815_114633` | 🔄 деплой | hide_zero+ФИЗ; KPI откл. по галочке; подписи 0 на пустых месяцах; локально OK — ждём ai.conall |
