...
| 14 | prescriptions | Предписания | `walk_20260816_113829` | 🔄 ждём OK | 16.08: 0%; мелкие сегменты скрыты; sticky Статус/Подрядчик/Проект; ждём OK на ai.conall после deploy |
