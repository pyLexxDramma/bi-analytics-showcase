...
def build_control_points_payload(*, project: str | None = None) -> dict[str, Any]:
    cache_key = f"v2|project={project or 'Все'}|db={WEB_DB_PATH}|mtime={db_status().get('mtime')}"
    ...
    try:
        ...
        for _, row in view.iterrows():
            ...
            projects.append({"project": str(row.get("project", "")), "cells": cells})
